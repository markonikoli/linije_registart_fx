...
public class AutoCompleteBox implements EventHandler{
    ...
    private void doAutoCompleteBox() {
        ...
        this.comboBox.getEditor().textProperty().addListener(new ChangeListener<String>() {

        	@Override
        	public void changed(ObservableValue<? extends String> observable, 
        			String oldValue, String newValue) {
        		System.out.println("Text changed");
        		if(!is_number(newValue)) return;
    ...
    public void handle(Event event) {
    	System.out.println("Evo event-a : " + event);
    	if(event instanceof KeyEvent) {
    		KeyEvent key_event = (KeyEvent)event;
    		if ( key_event.getCode() == KeyCode.UP || key_event.getCode() == KeyCode.DOWN
    				|| key_event.getCode() == KeyCode.RIGHT || key_event.getCode() == KeyCode.LEFT
    				|| key_event.getCode() == KeyCode.HOME
    				|| key_event.getCode() == KeyCode.END || key_event.getCode() == KeyCode.TAB
    				) {
    			return;
    		}

    		if(key_event.getCode() == KeyCode.BACK_SPACE){
    		...
    		if(key_event.getCode() == KeyCode.ENTER && comboBox.getSelectionModel().getSelectedIndex()>-1)
    			return;
